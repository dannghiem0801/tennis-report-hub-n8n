...
export function MatchRow({ match, compact: _compact, onOpenReport, onOpenScheduleModal, className }: MatchRowProps) {
  ...
  // because the score shape is goals, not sets. For now, this row
  // is rendered for tennis only; the dashboard filters by sport
  // upstream so football never hits this component in v1.5.
