...
const CATEGORY_COLORS: Record<TournamentCategory, string> = {
  ...
  // Football (v1.5 multi-sport)
  "World Cup": "bg-amber-500/15 text-amber-300 border-amber-500/20",
  "Continental Championship": "bg-orange-500/15 text-orange-300 border-orange-500/20",
  "Champions League": "bg-blue-500/15 text-blue-300 border-blue-500/20",
  "Europa League": "bg-indigo-500/15 text-indigo-300 border-indigo-500/20",
  "Conference League": "bg-violet-500/15 text-violet-300 border-violet-500/20",
  "Top Domestic League": "bg-emerald-500/15 text-emerald-300 border-emerald-500/20",
  "Other Domestic League": "bg-teal-500/15 text-teal-300 border-teal-500/20",
  "Domestic Cup": "bg-yellow-500/15 text-yellow-300 border-yellow-500/20",
  "V-League": "bg-red-500/15 text-red-300 border-red-500/20",
  Friendly: "bg-slate-500/15 text-slate-300 border-slate-500/20",
};
